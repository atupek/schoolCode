...
// I've implemented 5 rules.  Possible increased functionality is to rewrite this
// to cover all possible rules & allow the user to enter an integer from 0-255 to
// select the rule.  Though, some of the rules are not very interesting...
