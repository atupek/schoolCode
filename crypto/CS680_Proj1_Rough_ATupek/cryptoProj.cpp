...
//  due 2/25/15
//
//  Encrypt: Converts secret message into ASCII decimal value -32
...
//  Functionality to be added: allow user to select message text file and gcode file
//			and determine if gcode file has enough extruder commands to hold message
//			Also-possibly remove last three decimal places of Extruder commands and use straight ASCII values
//			instead of subtracting 32.  I wasn't sure how changing the last two decimal places would
//			modify the printed object, so I want to see how it turns out before making further modifications
//			to the gcode
#include <iostream>
#include <fstream>
#include <cstdio>
