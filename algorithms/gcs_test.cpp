...
// Test program for function gcs
// Used in Assignment 3, Exercise A

// Includes for code to be tested
#include "gcs.h"        // For function gcs
#include "gcs.h"        // Double inclusion test
...
// test_gcs_small
// Test suite for function gcs: small examples
// Pre: None.
// Post:
//     Pass/fail status of tests have been registered with t.
//     Appropriate messages have been printed to cout.
// Does not throw (No-Throw Guarantee)
void test_gcs_small(Tester & t)
{
    std::cout << "Test Suite: function gcs - small examples"
              << std::endl;
    ...
    t.test(gcs(vc.begin(), vc.end()) == 0, "Empty sequence");
    }
    ...
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 5, "Size 1, positive");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 0, "Size 1, negative");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 0, "Size 1, zero");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 8, "Size 2, pos pos");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 5, "Size 2, pos neg");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 3, "Size 2, neg pos");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 0, "Size 2, neg neg");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 6, "Size 3, #1");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 7, "Size 3, #2");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 8, "Size 3, #3");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 55, "Size 20, #1");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 58, "Size 20, #2");
    }
    ...
    std::vector<int> v(data, data+DATASIZE);
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(gcs(vc.begin(), vc.end()) == 61, "Size 20, #3");
    }
}


// test_gcs_large
// Test suite for function gcs: large examples
// Pre: None.
// Post:
//     Pass/fail status of tests have been registered with t.
//     Appropriate messages have been printed to cout.
// Does not throw (No-Throw Guarantee)
void test_gcs_large(Tester & t)
{
    std::cout << "Test Suite: function gcs - large examples"
              << std::endl;
    ...
    t.test(gcs(vc.begin(), vc.end()) == 6*N, "Large #1");
    }
    ...
    t.test(gcs(vc.begin(), vc.end()) == 2*N+4, "Large #2");
    }
    ...
    t.test(gcs(vc.begin(), vc.end()) == 7*N, "Large #3");
    }
    ...
    t.test(gcs(vc.begin(), vc.end()) == 9*N, "Large #4");
    }
}


// test_gcs_types
// Test suite for function gcs: type checking
// Pre: None.
// Post:
//     Pass/fail status of tests have been registered with t.
//     Appropriate messages have been printed to cout.
// Does not throw (No-Throw Guarantee)
void test_gcs_types(Tester & t)
{
    std::cout << "Test Suite: function gcs - type checking"
              << std::endl;
    ...
    std::vector<int> v;
    const std::vector<int> & vc(v);    // Const ref to above
    t.test(TypeCheck<int>::check(gcs(vc.begin(), vc.end())),
        "Return type is int");
    }
    ...
    t.test(gcs(vc.rbegin(), vc.rend()) == 6*N, "Unusual iterators");
    }
}


// test_gcs
// Test suite for function gcs
...
//     Appropriate messages have been printed to cout.
// Does not throw (No-Throw Guarantee)
void test_gcs(Tester & t)
{
    // Do all the test suites
    std::cout << "TEST SUITES FOR FUNCION gcs" << std::endl;
    test_gcs_small(t);
    test_gcs_large(t);
    test_gcs_types(t);
}
...
// main
// Runs function gcs test suite, prints results to cout.
int main()
{
    Tester t;
    test_gcs(t);
