...
#include "huffcode.h"   // For class HuffCode
#include "huffcode.h"   // Double inclusion test
...
void test_HuffCode_simple(Tester & t)
{
    ...
    cw.push_back(retval.substr(0, 1));
    cw.push_back(retval.substr(1, 2));
    cw.push_back(retval.substr(3, 2));
    ...
    retval = h.encode(text);
    correct = cw[0]+cw[0]+cw[0]+cw[1]+cw[0]+cw[2]
             +cw[1]+cw[0]+cw[1]+cw[1]+cw[1]+cw[2]
             +cw[2]+cw[0]+cw[2]+cw[1]+cw[2]+cw[2];
    result = (retval == correct);
    ...
    // Decode longer text
    text = cw[0]+cw[1]+cw[2]+cw[0]+cw[2]+cw[1]
          +cw[1]+cw[0]+cw[2]+cw[1]+cw[2]+cw[0]
          +cw[2]+cw[0]+cw[1]+cw[2]+cw[1]+cw[0]
          +cw[0]+cw[0]+cw[0]+cw[1]+cw[1]+cw[1]+cw[2]+cw[2]+cw[2];
    retval = h.decode(text);
...
void test_HuffCode_complex(Tester & t)
{
    ...
    std::vector<std::string> cw;
    cw.push_back(retval.substr(0, 5));
    cw.push_back(retval.substr(5, 2));
    cw.push_back(retval.substr(7, 4));
    cw.push_back(retval.substr(11, 3));
    cw.push_back(retval.substr(14, 3));
    cw.push_back(retval.substr(17, 4));
    cw.push_back(retval.substr(21, 3));
    cw.push_back(retval.substr(24, 5));
    cw.push_back(retval.substr(29, 3));
    cw.push_back(retval.substr(32, 4));
    ...
    retval = h.encode(text);
    correct = cw[0]+cw[9]+cw[0]+cw[1]+cw[2]+cw[5]+cw[5]+cw[7]
             +cw[2]+cw[3]+cw[8]+cw[7]+cw[6]+cw[9]+cw[8]+cw[7]
             +cw[6]+cw[5]+cw[4]+cw[3]+cw[2]+cw[1]+cw[0];
    result = (retval == correct);
    t.test(result, "encode longer text");
    ...
    // Decode longer text
    text = cw[6]+cw[9]+cw[0]+cw[8]+cw[9]+cw[9]+cw[3]+cw[3]+cw[3]
          +cw[4]+cw[8]+cw[9]+cw[2]+cw[6]+cw[1]+cw[7]+cw[4]+cw[0]
          +cw[5]+cw[1]+cw[5]+cw[0]+cw[2]+cw[8]+cw[8]+cw[8];
    retval = h.decode(text);
