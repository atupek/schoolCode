...
// Test program for function countInv
// Used in Assignment 3, Exercise B

// Includes for code to be tested
#include "countinv.h"   // For function countInv
#include "countinv.h"   // Double inclusion test
...
// test_countInv_small
// Test suite for function countInv: small examples
// Pre: None.
// Post:
//     Pass/fail status of tests have been registered with t.
//     Appropriate messages have been printed to cout.
// Does not throw (No-Throw Guarantee)
void test_countInv_small(Tester & t)
{
    std::cout << "Test Suite: function countInv - small examples"
              << std::endl;
    ...
    t.test(countInv(v.begin(), v.end()) == ans,
        "Empty sequence");
    }
...
// test_countInv_large
// Test suite for function countInv: large examples
// Pre: None.
// Post:
//     Pass/fail status of tests have been registered with t.
//     Appropriate messages have been printed to cout.
// Does not throw (No-Throw Guarantee)
void test_countInv_large(Tester & t)
{
    std::cout << "Test Suite: function countInv - large examples"
              << std::endl;
...
// test_countInv_types
// Test suite for function countInv: type checking
// Pre: None.
// Post:
//     Pass/fail status of tests have been registered with t.
//     Appropriate messages have been printed to cout.
// Does not throw (No-Throw Guarantee)
void test_countInv_types(Tester & t)
{
    std::cout << "Test Suite: function countInv - type checking"
              << std::endl;

    {
    // Return type
    std::vector<int> v;
    t.test(TypeCheck<std::size_t>::check(countInv(v.begin(), v.end())),
    ...
    size_t ans = size_t(N*(N-1));      // Correct result
    t.test(countInv(v.rbegin(), v.rend()) == ans,
        "Unusual iterators");
    }
}
...
// test_countInv
// Test suite for function countInv
...
//     Appropriate messages have been printed to cout.
// Does not throw (No-Throw Guarantee)
void test_countInv(Tester & t)
{
    // Do all the test suites
    std::cout << "TEST SUITES FOR FUNCION countInv" << std::endl;
    test_countInv_small(t);
    test_countInv_large(t);
    test_countInv_types(t);
}
...
// main
// Runs function countInv test suite, prints results to cout.
int main()
{
    Tester t;
    test_countInv(t);
